...
public class BarCodeUtil {
    ...
    public static String getBarCodeBase64(String content, int width, int height) throws WriterException, IOException {
        return Base64.getEncoder().encodeToString(getBarCodeByteArray(content, width, height));
    }
    ...
    public static String getBarCodeWordsBase64(String codeValue,
        ...
        return Base64.getEncoder().encodeToString(getBarCodeWordsByteArray(codeValue, bottomStr, topLeftStr, topRightStr, pictureWidth, pictureHeight, codeOffsetX, codeOffsetY, topLeftOffsetX, topLeftOffsetY, topRightOffsetX, topRightOffsetY, fontSize));
    }
     ...
     * @return byte[]
     */
    public static byte[] getBarCodeWordsByteArray(String codeValue, String bottomStr) throws IOException {
